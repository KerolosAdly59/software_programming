...
var Input_Search_products=document.getElementById("Search_product");
...
function searchBYProductName(Search_value)
{
  console.log(Search_value);
    ...
    // var text= "KOROLUS boles love electronics "
    // console.log(    text.split( " " , 2)   );
    // console.log(    text.split( " " , 2).join(" ")   );
